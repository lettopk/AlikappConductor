...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    private android.widget.TextView rideLocation;
    private android.widget.TextView rideDistance;
    private android.widget.TextView rideDate;
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
       ...
       // intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config);
        ...
        rideLocation = (android.widget.TextView) findViewById(R.id.rideLocation);
        rideDistance = (android.widget.TextView) findViewById(R.id.rideDistance);
        rideDate = (android.widget.TextView) findViewById(R.id.rideDate);
        userName = (android.widget.TextView) findViewById(R.id.userName);
        userPhone = (android.widget.TextView) findViewById(R.id.userPhone);
    ...
    private void displayCustomerRelatedObjects() {
        ...
        mPay.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
...
/*
    ...
    private static PayPalConfiguration config = new PayPalConfiguration()
            ...
            .clientId(PayPalConfig.PAYPAL_CLIENTE_ID);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(map.get("profileImageUrl") != null){
                        com.bumptech.glide.Glide.with(getApplication()).load(map.get("profileImageUrl").toString()).into(userImage);
                    }
                }
    ...
    private void getRouteToMarker() {
        com.directions.route.Routing routing = new com.directions.route.Routing.Builder()
<<<<<<< HEAD
                .key("AIzaSyC5qe0PdRWO9qvCo4rNuyNrXyf8K06SbbI")
=======
>>>>>>> 5656ae9f16a4ce1af2f63731f03e719aadbf53ac
    ...
    private java.util.List<Polyline> polylines;
